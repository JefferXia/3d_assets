Motion: "Victory Dance 61" from the game PUBG (PlayerUnknown's Battlegrounds), converted to VMD by JohnyL.
...
Your models need to have upperbody2 bone (上半身2), and in A-pose. The legs need to be parallel to each other.
...
<<<About the motion>>>
The motion is called "Victory Dance 61" and the music is unknown as it was made by the game devs.
In the game, the animation loops from frame 8 to frame 462.5, meaning frame 8 is identical to frame 917.
(The decimal number here is because I cut it down from 60 fps to 30 fps for the use in MMD).

<<<Side notes>>>
The included music file was extracted from the game. I extended and added fade out effect at the end.
I removed the first 10 frames from the original animation to get rid of the default standing idle pose.

That's all. Thanks for reading!
@johnwithlenon

*Changelog*
- v2.0 (2022/12/12): Fixed the legs and fingers. Removed keyframes of waist bone.
- v1.0 (2022/09/19): First release.